...
public class Partitioning {	
	public static void main(String... args){	
		...
		Map<Boolean, List<State>> statesByCoast1 = states.stream().collect(partitioningBy(State::isEastCoast));	
		...
		Map<Boolean, Map<LOCATION, List<State>>> statesByCoast2 = states.stream().collect(partitioningBy(State::isEastCoast, groupingBy(State::getLocation)));
		System.out.println("**************************************East Coast States**************************************");
		...
		Map<Boolean, Long> statesByCoast3 = states.stream().collect(partitioningBy(State::isEastCoast, counting()));
